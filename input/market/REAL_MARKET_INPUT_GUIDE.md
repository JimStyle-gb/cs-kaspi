...
- `input/market/manual/demiand_manual_market.csv` — ручной безопасный источник.
...
3. Переноси заполненные строки в `input/market/manual/demiand_manual_market.csv`, `input/market/ozon/demiand_ozon_market.csv` или `input/market/wb/demiand_wb_market.csv`.
