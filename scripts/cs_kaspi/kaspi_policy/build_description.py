...
def run(product: dict) -> str:
    ...
    items = [
        ...
        _line("Рыночный вариант", market.get("market_title")),
    ...
    if market.get("market_bundle") or market.get("market_title"):
        parts.append("<p>Комплектация и рыночный вариант берутся из подтверждённой карточки Ozon/WB, а технические характеристики — из официального источника поставщика.</p>")
    else:
