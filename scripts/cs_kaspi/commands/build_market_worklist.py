...
7. Либо перенеси заполненные строки в боевой input-файл: input/market/manual/demiand_manual_market.csv, input/market/ozon/demiand_ozon_market.csv или input/market/wb/demiand_wb_market.csv.
