...
from scripts.cs_kaspi.kaspi.build_update_plan import run as build_plan
from scripts.cs_kaspi.kaspi.build_update_payload import run as build_payload
...
def run() -> dict:
    ...
    write_json(get_path("artifacts_state_dir") / "update_plan.json", plan)
    write_json(get_path("artifacts_exports_dir") / "update_payload.json", payload)
    return payload
